...
bot invite link: https://discordapp.com/oauth2/authorize?client_id=517006321904517140&scope=bot&permissions=0
...
https://discordapp.com/oauth2/authorize?client_id=517006321904517140&scope=bot&permissions=0
`);
...
console.log(`**The RIVER Bot** Leave From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
client.channels.get("390983810889678868").send('**The RIVER Bot** ``Kicked`` From Server - -- = '+`**${guild.name}**`+' = -- '+'**Server Owner** -- =' +`**${guild.owner.user.username}**` +'= --')
});

client.on("guildCreate", guild => {
client.channels.get("390983810889678868").send(`**The RIVER Bot** has been **added** ❤ from this server **(${guild.name})** , Server Owner 👑 **(${guild.owner.user.username})**`)
});

client.on("guildDelete", guild => {
client.channels.get("390983810889678868").send(`**The RIVER Bot** has been **removed** 😔 from this server **(${guild.name})** , Server Owner 👑 **(${guild.owner.user.username})**`)
});
...
client.on('guildMemberAdd', member => {
    ...
    .setColor('GREEN')
    .setFooter('The RIVER Bot', 'https://cdn.discordapp.com/icons/390551815072251904/418fa2788d8115808951c9881ba8f190.jpg')
...
client.login('NTE3OTg3OTM1NzU3NTMzMTg2.DuKPNw.Y24VmhKncOA9UxV4LnOXOJq_Dd8');
