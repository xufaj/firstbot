...
client.on('ready', () => {
  client.user.setGame(` By SAJED...👻#8844 .`,'https://www.twitch.tv/v5bz');
  console.log('---------------');
...
if (message.content === '*help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: **","**@SAJED...👻#8844 **")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`TOKYO Bot- Script By : SAJED...👻#8844 `);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : SAJED...👻#8844  ' `);
    console.log(`----------------`);
...
client.login("NTE3OTg3OTM1NzU3NTMzMTg2.DuKOtQ.3j1jLXTMZU_EAafiMjR5cENiUCE");
